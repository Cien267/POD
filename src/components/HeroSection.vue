<template>
  <div class="font-roboto">
    <div
      class="grid lg:grid-cols-1 items-center lg:gap-y-6 bg-blue-500 relative"
    >
      <div
        class="max-lg:order-1 max-lg:text-center sm:p-12 p-4 absolute left-10 top-1/2s lg:w-[500px]"
      >
        <h2
          class="text-slate-100 lg:text-5xl text-3xl font-bold lg:!leading-[56px]"
        >
          In phong cách, tạo khác biệt
        </h2>
        <p class="text-slate-300 mt-6 text-base leading-relaxed">
    ...
    <div class="max-w-6xl mx-auto font-[sans-serif] my-20">
      <h2
        class="text-gray-800 sm:text-4xl text-2xl font-extrabold text-center mb-16"
      >
        Khám Phá Những Tính Năng Độc Quyền
      </h2>
      <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
        <div class="text-center">
          ...
          <h3 class="text-gray-800 text-xl font-semibold mb-3">
            Thiết kế dễ dàng theo ý bạn
          </h3>
          <p class="text-gray-600 text-sm">
            Tải lên ý tưởng hoặc sử dụng mẫu có sẵn để tạo ra những thiết kế độc
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm">
            Nhận sản phẩm tùy chỉnh của bạn được giao tận nơi một cách nhanh
            chóng.
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm">
            Đội ngũ của chúng tôi luôn sẵn sàng hỗ trợ bạn mọi lúc, mang đến
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm">
            Thưởng thức những bản in sắc nét, bền màu trên mọi sản phẩm chúng
            tôi cung cấp.
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm">
            Từ trang phục đến đồ trang trí nhà cửa, lựa chọn từ nhiều sản phẩm
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm">
            Chúng tôi ưu tiên tính bền vững với mực in thân thiện môi trường và
            bao bì tái chế.
          </p>
        </div>
      </div>
